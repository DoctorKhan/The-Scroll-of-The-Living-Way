...
\usepackage{ebgaramond} % The Classic Serif Font
\usepackage{microtype}  % Essential for spacing
...
% PREVENTS BREAKING SAYINGS ACROSS PAGES
...
than for the one rich in ego to enter the Kingdom. \\
