...
\section*{6. The Soft Overcomes the Hard}
The soul is as soft as breath. \\
The ego is as hard as stone. \\
Yet breath wears down mountains, \\
and the stone crumbles in the wind.

So it is with the passions: \\
Do not fight them. \\
Let them dissolve in the seeing that is without judgment.
...
\section*{8. The Water of the Living Father}
Be like the water that seeks the lowest place. \\
It does not contend, yet nothing withstands it. \\
...
The Living One does not command belief. \\
The Living One reveals what is hidden \\
so the seeker may see with their own eyes.

A master gives answers; \\
but the Living Jesus gives questions, \\
so the disciple may become a master.
...
Thus the Living One leaves no trace, \\
and yet the footsteps are everywhere.
...
The Living One does not raise the proud; \\
The Living One raises only the one \\
...
\section*{28. Returning to the Valley}
Know the strength, \\
yet keep to the softness— \\
the receptive valley through which the river flows.
...
Thus the Living One guides by reversal, \\
...
The softest thing in existence overpowers the hardest stone. \\
...
\section*{46. Desire and Sufficiency}
When the Way is lived, horses graze peacefully. \\
When the Way is forgotten, war horses wander the streets.

Desire creates restlessness. \\
Sufficiency creates peace.
...
\section*{49. The Heart of the Sage}
...
Those who know the Living One fear neither.
...
Thus the sage completes the work and forgets the work— \\
...
Yet the Living One speaks through silence \\
...
Rule a kingdom as you would cook a small fish: gently. \\
The sage governs by not ruling, \\
teaches by not preaching, \\
achieves by not striving. \\
Thus the world settles in such presence.

\section*{61. The Valley of the World}
The great kingdom is like a lowly valley. \\
All streams flow toward it because it does not exalt itself. \\
Thus the sage becomes the refuge of all \\
...
Thus the sage rules by staying below. \\
...
One who embodies the Way walks unseen.
...
The sage lives lightly, needing little. \\
Carrying no burden, fearing no loss.

\section*{76. The Softness of Life}
At birth, we are soft and fluid. \\
At death, we are stiff and dry. \\
Thus softness is life; hardness is death. \\
The one who remains supple cannot be broken.

\section*{77. The Bow of Heaven}
The Father's way is like drawing a bow: \\
raising the low, lowering the high, \\
balancing all without judgment. \\
So too the sage gives to the needy without claiming virtue.

\section*{78. Water and the Word}
Nothing is softer than water, \\
yet nothing overcomes stone more completely. \\
So too the Word of the Living One overcomes all division \\
not by force but by dissolving illusion.
...
The Living One gives freely, without possessing.

The more the sage gives, the greater the store— \\
...
\textbf{The Living One:} A title for the Christ/Master that emphasizes His eternal, present reality rather than his historical past. He is the one who "is" rather than the one who "was."
